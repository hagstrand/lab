 ...
 * </pre>
 */
function When(decidate, precision, stdev) {
	...
	this.precision = precision ? precision : When.YEAR;
	this.stdev = stdev ? stdev : 0;

}

/** precision code */ When.UNDEFINED   =    0;
/** precision code */ When.MILLENIUM   = 1000;
/** precision code */ When.CENTURY     = 100;
/** precision code */ When.DECADE      = 10;
/** precision code */ When.YEAR        = 1;
/** precision code */ When.MONTH       = -4000;
/** precision code */ When.DAY         = -5000;
/** precision code */ When.HOUR        = -6000;
/** precision code */ When.MINUTE      = -7000;
/** precision code */ When.SECOND      = -8000;
/** precision code */ When.MILLISECOND = -9000;
...
When.prototype = {
	...
	deserialize: function(s) {
		var a = s.split("_");
		this.decidate = a[0];
		this.precision = (a.length > 0) ? a[1] : When.YEAR;
	...
	format : function(pattern) {
		...
		if (pattern && pattern != "detail") {
			var d = this.toDate();
			var D = d.getDate();
			var m = When.strings.i18n.monthNames[d.getMonth()];
			var y = d.getFullYear();
			var H = d.getHours();
			var M = d.getMinutes();
			var S = d.getSeconds();
	...
	/**
	 * Set the datetime value from a Javascript Date object.
