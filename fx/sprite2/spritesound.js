...
Sprite.prototype.setup = function(container, a, fxfiles, urlpattern) {
	...
	this.sound.loadSounds(urlpattern, fxfiles, function() {
		self.onload('audio');
	});
	...
	this.image.onload = function() {self.onload('image');};
	this.image.src = this.imageurl;
}

Sprite.prototype.onload = function(type) {
	this.imageloaded = (type == 'image') ? true : false;
	this.audioloaded = (type == 'audio') ? true : false;
...
Sprite.prototype.explode = function() {
	...
	this.sound.play('explosionshort');
}
