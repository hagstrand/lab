...
voyc.fx.Game.prototype.start = function () {
...
voyc.fx.Game.prototype.stop = function () {
	log&&console.log('stop');
	this.running = false;
}

voyc.fx.Game.prototype.step = function (timestamp) {
...
voyc.fx.Game.prototype.render = function (delta) {
	log&&console.log('render ' + delta + ' ' + this.elapsed + ' ' + this.frames + ' ' + this.fps);
	this.onRender(delta);
}
